...
export default function Footer() {
    return (
        <footer className="min-h-screen bg-[#0C131B] text-white flex flex-col justify-between w-full">
            {/* Main Heading */}
            <div className="my-container py-[4vw]">
                <div className="mb-[5vw] ">
                    <h1 className="text-[8vw]  md:text-[15vw] font-black text-[#F1EDE0] leading-tight">
                        SAY HI!
                    </h1>
                </div>
                ...
                <div className="flex flex-row justify-between items-center gap-[9vw] mb-[5vw] text-left">
                    {/* Pages Column */}
                    <div className="w-[20%]">
                        <h3 className="text-[1.2vw] font-semibold mb-[1.5vw] text-white">PAGES</h3>
                        <ul className="space-y-[0.6vw] text-[0.8vw]">
                    ...
                    {/* Address Column */}
                    <div className="w-[40%]">
                        <h3 className="text-[1.2vw] font-semibold mb-[1.5vw] text-white">ADDRESS</h3>
                        <div className="space-y-[2vw] text-[1vw]">
                            <div>
                    ...
                    {/* Contact Column */}
                    <div className="w-[40%]">
                        <p className="text-[1vw] mb-[1.5vw] text-white leading-snug">
                ...
                <div className="relative w-full">
                    ...
                    <div className="flex items-center w-full justify-between">
                        ...
                        <button className="flex items-center gap-[0.5vw] whitespace-nowrap text-[0.9vw] bg-gradient-to-r from-[#B89C56] via-[#F2D7BC] to-[#B89C56] bg-clip-text text-transparent hover:opacity-80 transition">
                            BACK TO TOP
                            <svg className="w-[1.7vw] h-[2vw]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                ...
                                <path d="M12 19V5M5 12l7-7 7 7" stroke="url(#arrowStrokeGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </button>
                    </div>
                </div>
