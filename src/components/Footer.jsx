...
export default function Footer({ theme = "main" }) {
    // Dynamic heading class
    const headingClass =
        theme === "theme-blue"
            ? "text-gradient"
            : "text-white";
        ...
        >
            <div className="my-container py-[4vw]">
                ...
                <div className="mb-[5vw] ">
                    <h1
                        className={`animate-heading text-[8vw] md:text-[15vw] font-black leading-tight ${headingClass}`}
                    >
                        SAY HI!
                    </h1>
                </div>
                ...
                <div className="flex flex-row justify-between items-center gap-[9vw] mb-[5vw] text-left">
                    ...
                    <div className="w-[40%] animate-links">
                        ...
                        <div className="flex justify-start items-center gap-[2vw]">
                            <a href="tel:+971586996635" className="group flex items-center gap-[1vw] text-[1vw] transition-all duration-300">
                            ...
                            <a href="mailto:ALI@AZES-INTL.COM" className="group flex items-center gap-[1vw] text-[1vw] transition-all duration-300">
                                <span className="w-[3vw] h-[3vw] bg-[#085859] rounded-full flex items-center justify-center group-hover:bg-teal-400 transition-all duration-300">
                ...
                <div className="relative w-full animate-links">
                    <div className="flex items-center w-full justify-between">
                        ...
                        <div className="flex flex-col w-[92%]">
                            <div className="flex flex-wrap items-center gap-[4vw] text-[0.99vw] text-white mb-[0.5vw]">
                                ...
                                {["LINKEDIN", "FACEBOOK", "INSTAGRAM", "YOUTUBE"].map((item) => (
                                    <a key={item} href="#" className="group inline-block relative overflow-hidden">
                                        <span className="block transition-transform duration-500 group-hover:-translate-y-full">
                                            {item}
                                        </span>
                                        <span className="absolute top-0 left-0 transition-transform duration-500 translate-y-full group-hover:translate-y-0">
                        ...
                        >
                            BACK TO TOP
                            <svg className="w-[1.7vw] h-[2vw]" viewBox="0 0 24 24" fill="none">
                                <defs>
